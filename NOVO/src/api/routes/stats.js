...
export default function statsRoutes(prisma, getMongoClient) {
   ...
   */
  router.get('/average-time', (req, res) => statsController.averageTime(req, res, prisma));
   ...
   */
  router.get('/average-time/by-day', (req, res) => statsController.averageTimeByDay(req, res, prisma));
   ...
   * Query params: servidor, unidadeCadastro, startDate, endDate
   */
  router.get('/average-time/by-week', (req, res) => statsController.averageTimeByWeek(req, res, prisma));
   ...
   */
  router.get('/average-time/by-month', (req, res) => statsController.averageTimeByMonth(req, res, prisma));
   ...
   */
  router.get('/average-time/stats', (req, res) => statsController.averageTimeStats(req, res, prisma));
   ...
   * Query params: servidor, unidadeCadastro, meses, apenasConcluidos
   */
  router.get('/average-time/by-unit', (req, res) => statsController.averageTimeByUnit(req, res, prisma));
   ...
   * Query params: servidor, unidadeCadastro, meses, apenasConcluidos
   */
  router.get('/average-time/by-month-unit', (req, res) => statsController.averageTimeByMonthUnit(req, res, prisma));
