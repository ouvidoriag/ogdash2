 ...
 * FASE 2.2: Prevenir vazamentos de memória com setTimeout/setInterval
 * Garante limpeza automática de timers
 */

class TimerManager {
  constructor() {
    this.timers = new Map(); // Map<id, {type: 'timeout'|'interval', id: number, callback: function, cleanup: function}>
    this.nextId = 1;
  }
